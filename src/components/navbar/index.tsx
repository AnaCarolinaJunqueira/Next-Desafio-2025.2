...
export default function Header(){
    ...
    return(
        <header className="bg-darker-midnight-blue stcky top-0 z-20 mx-auto w-full py-4 px-6 bp-840:p-0 mb-8">

            <nav className="flex items-center justify-between w-full bp-840:w-11/12 mx-auto">
            <div className="flex justify-between mx-auto">
                ...
                <Link href="/" className="flex gap-4 items-center">
                    ...
                    />
                    <span className="text-white hidden bp-840:block text-[20px] font-semibold">Covil das Cartas</span>
                </Link>
            </div>
                {/*Links do meio */}
                <div className="flex-1 hidden justify-center gap-8 bp-840:flex">
                ...
                {/*Links da direita*/}
                <div className="hidden bp-840:flex justify-center gap-6 items-center w-[282px] h-[120px]">
                ...
                {/*menu hamburger */}
                <button className="bp-840:hidden text-white" onClick={toggleNav}>
            ...
            {isNavOpen && (
                <div className="bp-840:hidden flex flex-col items-center justify-center mt-4 gap-4">
                    {links1.map((link, index) => (
